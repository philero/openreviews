...
SCRIPT
  ...
  config.vm.provision :chef_solo do |chef|
    ...
    chef.json = {java: {jdk_version: 7, accept_license_agreement: true},
      'sbt-extras' => {download_url: 'https://github.com/paulp/sbt-extras/raw/aec6170d54cc05e625cbea7d3681ba2f1db3fd6f/sbt',
        default_sbt_version: '0.13.1',
        group_new_members: ['vagrant']}}



    chef.add_recipe "mongodb::10gen_repo"
    chef.add_recipe "mongodb::default"
    chef.add_recipe "sbt-extras::default"
